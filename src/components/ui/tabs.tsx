...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 mb-2 items-center justify-center p-1 text-border-grey font-semibold",
      className
    )}
    {...props}
  />
